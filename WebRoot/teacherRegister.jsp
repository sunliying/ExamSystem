		...
		$(function(){
			...
			form.onsubmit = function(){
				...
				if (password.value!=identify_password.value) {
					...
					document.getElementById("form1").action="TeacherRegister.do";
				}
			};
		});
	</script>
	...
	<div class="content">
		...
		<form id="form1" class="form1" autocomplete="on" method = "post" >
			...
			<div class="input-group">
			  ...
			  <input required="required" type="number" max="2017000000" name="tid" class="form-control" placeholder="小于等于10位数，开头小于2017">
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				<span class="input-group-addon">主攻方向：</span>
			 	<input required="required" type="textarea" name="title" class="form-control" placeholder="请描述你的主攻方向">
